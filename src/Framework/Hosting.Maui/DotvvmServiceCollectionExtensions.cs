...
public static class DotvvmServiceCollectionExtensions
{
        ...
        where TDotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator, new()
    {
        return builder.AddMauiDotvvmWebView<TDotvvmStartup, TDotvvmStartup>(applicationPath, webRootPath, debug,
            configure, configureBeforeDotvvm, configureAfterDotvvm);
    }
        ...
        where TDotvvmServiceConfigurator : IDotvvmServiceConfigurator, new()
    {
        ...
        builder.Services.AddSingleton<RequestDelegate>(provider =>
            GetRequestDelegate<TDotvvmStartup>(provider, environment, debug, configure, configureBeforeDotvvm,
                configureAfterDotvvm));
    ...
    private static DotvvmWebHostEnvironment RegisterEnvironment(MauiAppBuilder builder, string applicationPath,
        string? webRootPath, bool debug)
    {
